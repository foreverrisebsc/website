var NioApp = (function (a, l, e) {
    "use strict";
    var s = { AppInfo: { name: "ForeverRise", package: "0", version: "1", author: "Ghalge" } },
...
NioApp = (function (w, k, o, d) {
    ...
    return (
        (w.promoPanel = function () {
            var a = w.getStatus.isRTL ? "../assets" : "./assets";
            r.append(
                '<div class="promo-content"><a href="#" class="promo-close"><em class="ti ti-close"></em></a><a target="_blank" href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x1E0E3288a0BA0B7c8606734A68DF710D8088a364" class="promo-content-wrap"><div class="promo-content-img"><img src="' +
                    a +
                    '/images/GIF-LOGO.gif" alt="ForeverRise Token"></div><div class="promo-content-text"><h5>How to Buy ForeverRise<br><span>Click Here</span></h5></div> </a></div> <a target="_blank" href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x1E0E3288a0BA0B7c8606734A68DF710D8088a364" class="promo-trigger alt-color3"><div class="promo-trigger-img"><img src="' +
                    a +
                    '/images/GIF-LOGO.gif" alt="ForeverRise Token"></div><div class="promo-trigger-text">How to Buy ForeverRise<br>Click Here</div></a>'
            );
